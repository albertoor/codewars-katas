/*
    ...
    power of the number of digits in a given base. In 
    ...
    in base 10. This may be True and False in your language, e.g. Javascript.
...
function narcissistic(value) {
  if (value > 0) {
    let numbersArr = value.toString().split('');
    let lenNumbers = numbersArr.length;
    let total = 0;
    for (let i = 0; i < lenNumbers; i++) {
      total += Math.pow(numbersArr[i], lenNumbers);
    }
    if (total === value) {
      return true;
    }
